...
const passportProcessing = require('./adventCalc.ts');
let testString = require('./string.ts');
...
describe('AdventCalc', function () {
    ...
    describe('PassportProcessing', function () {
        ...
        it('should return 0', function () {
            let inputExample: string = `eyr:1972 cid:100
            ...
            var result = passportProcessing.PassportProcessing(inputExample);
            console.log(result);
            assert.equal(result, 0);
        });

        // it('should return 4', function () {
        //     let inputExample: string = `pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980
        //     hcl:#623a2f
        ...
        it('should return puzzle result 198', function () {
            let testString: string = `eyr:2028 iyr:2016 byr:1995 ecl:oth
...
hcl:#602927 iyr:2013 byr:2003 eyr:2023 cid:100`;
            var result = passportProcessing.PassportProcessing(testString);
            console.log(result);
