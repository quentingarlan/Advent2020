...
// const inputTest = require('./string.ts');
let customCustoms = require('./adventCalc.ts');

describe('AdventCalc', function () {

    describe('CustomCustoms', function () {

        it('should return 3299', function () {
            ...
            b`;
            var result = customCustoms.CustomCustoms(input);
            assert.equal(result, 6);
        });

        it('should return ', function () {
            let testString: string = `donpevkjhymzl
ezyopckdlnvmj
...
lmzuqfewdjsvrgtahbiny`;
            ...
            var result = customCustoms.CustomCustoms(testString);
            assert.equal(result, 3299);
        });
    });
