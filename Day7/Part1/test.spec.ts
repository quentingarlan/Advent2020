...
let handyHaversacks = require('./adventCalc.ts');
...
dotted black bags contain no other bags.`;
            var result = handyHaversacks.HandyHaversacks(input);
            assert.equal(result, 4);
        });

//         it('should return ', function () {
//             let testString: string = `striped green bags contain 5 posh indigo bags.
...
//             var result = handyHaversacks.HandyHaversacks(testString);
